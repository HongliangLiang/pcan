...
class TreeTransformer(nn.Module):
    ...
    def __init__(self, args, vocab: torchtext.vocab.Vocab = None, embedding=None):
        ...
        self.out_feats = getattr(args, 'out_feats', 128)
    ...
    def forward(self, graph: dgl.DGLGraph):
        ...
        for g in graphs:
            idx = list(range(g.number_of_nodes()))
            indexes.append(idx)
...
class CodeCloneClassifier(nn.Module):
    ...
    def __init__(self, args, vocab=None, embedding=None):
        ...
        self.fc = torch.nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(2 * out_feats, out_feats // 2),
    ...
    def forward(self, x):
        ...
        return self.fc(torch.cat([l, r], dim=-1)).squeeze(-1)
